import desktopAnimationData from 'assets/animations/claim/desktop/animation_5.json';
import mobileAnimationData from 'assets/animations/claim/mobile/animation_5.json';
...
export const ClaimStep5: React.FunctionComponent<ClaimStepProps> = ({ onContinue }) => {
