import desktopAnimationData from 'assets/animations/claim/desktop/animation_4.json';
import mobileAnimationData from 'assets/animations/claim/mobile/animation_4.json';
