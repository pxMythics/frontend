import desktopAnimationData from 'assets/animations/claim/desktop/animation_3.json';
import mobileAnimationData from 'assets/animations/claim/mobile/animation_3.json';
