import desktopAnimationData from 'assets/animations/claim/desktop/animation_6.json';
import mobileAnimationData from 'assets/animations/claim/mobile/animation_6.json';
